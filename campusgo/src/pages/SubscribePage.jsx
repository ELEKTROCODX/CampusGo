...
function SubscribePage() {
    ...
    const [loading, setLoading] = useState(false); // [variable, funcion]
    const [error, setError] = useState(null);     // [variable, funcion]
    ...
    const handleRegistration = async (e) => {
        ...
        try {
            ...
            const userData = { name, email, company: company || "N/A", topic: assignedTopic, registeredAt: registrationDate };

            if (fcmToken) {
                userData.fcmToken = fcmToken;
                await subscribeToTopicCallable({ token: fcmToken, topic: assignedTopic, userId: user.uid });
                console.log("Suscripción a topic intentada para:", assignedTopic);
            }
